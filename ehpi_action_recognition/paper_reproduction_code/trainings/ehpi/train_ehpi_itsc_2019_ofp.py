...
def get_sim_pose_algo_only(image_size: ImageSize):
    num_joints = 15
...
def get_sim_gt_only(image_size: ImageSize):
    num_joints = 15
    left_indexes: List[int] = [3, 4, 5, 9, 10, 11]
    right_indexes: List[int] = [6, 7, 8, 12, 13, 14]
...
def get_full(image_size: ImageSize):
    num_joints = 15
    left_indexes: List[int] = [3, 4, 5, 9, 10, 11]
    right_indexes: List[int] = [6, 7, 8, 12, 13, 14]
    ...
    datasets: List[EhpiDataset] = [
        # Real
    EhpiDataset("/media/disks/beta/datasets/ehpi/ofp_webcam",
                             transform=transforms.Compose([
                                 RemoveJointsOutsideImgEhpi(image_size),
                                 ScaleEhpi(image_size),
                                 TranslateEhpi(image_size),
    ...
    EhpiDataset("/media/disks/beta/datasets/ehpi/ofp_record_2019_03_11_30FPS",
                             transform=transforms.Compose([
                                 RemoveJointsOutsideImgEhpi(image_size),
                                 ScaleEhpi(image_size),
                                 TranslateEhpi(image_size),
    ...
    EhpiDataset("/media/disks/beta/datasets/ehpi/ofp_record_2019_03_11_HSRT_30FPS",
                             transform=transforms.Compose([
                                 RemoveJointsOutsideImgEhpi(image_size),
                                 ScaleEhpi(image_size),
                                 TranslateEhpi(image_size),
    ...
    EhpiDataset("/media/disks/beta/datasets/ehpi/ofp_record_2019_03_11_HELLA_30FPS",
                             transform=transforms.Compose([
                                 RemoveJointsOutsideImgEhpi(image_size),
                                 ScaleEhpi(image_size),
                                 TranslateEhpi(image_size),
    ...
    # Freilichtmuseum
    EhpiDataset("/media/disks/beta/datasets/ehpi/2019_03_13_Freilichtmuseum_30FPS",
                             transform=transforms.Compose([
                                 RemoveJointsOutsideImgEhpi(image_size),
                                 ScaleEhpi(image_size),
                                 TranslateEhpi(image_size),
    ...
    # Simulated
    EhpiDataset("/media/disks/beta/datasets/ehpi/ofp_from_mocap_30fps/",
                             transform=transforms.Compose([
                                 RemoveJointsOutsideImgEhpi(image_size),
                                 RemoveJointsEhpi(indexes_to_remove=foot_indexes, indexes_to_remove_2=knee_indexes, probability=0.25),
                                 ScaleEhpi(image_size),
...
def get_set_wo_sim(image_size: ImageSize):
    num_joints = 15
    left_indexes: List[int] = [3, 4, 5, 9, 10, 11]
    right_indexes: List[int] = [6, 7, 8, 12, 13, 14]
...
if __name__ == '__main__':
    ...
    for seed in seeds:
        for dataset_name, get_dataset in datasets.items():
            ...
            # config
            train_config = TrainingConfigBase("itsc2019_{}_seed_{}".format(dataset_name, seed), "/media/disks/beta/models/itsc_2019_v2")
